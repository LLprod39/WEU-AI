...
class SmartTaskAnalyzer:
    ...
    def _analyze_with_cursor_ask(self, task: str, context: dict[str, Any] | None = None) -> dict[str, Any]:
        """
...
"""
        ...
        logger.info("Running Cursor CLI --mode=plan --model auto for task analysis")
    ...
    def analyze(self, task: str, context: dict[str, Any] | None = None, use_llm: bool = True) -> AnalysisResult:
        """
    ...
    async def analyze_async(self, task: str, context: dict[str, Any] | None = None, use_llm: bool = True) -> AnalysisResult:
        """

...
import { AlertTriangle, ArrowLeft, Bot, CheckCircle2, Loader2, Search, Server, Shield, Sparkles, WandSparkles } from "lucide-react";
                ...
                <div className="space-y-4">
                  <div className="rounded-xl border border-border/70 bg-background/24 p-5">
                    ...
                    {selectedSkill.ui_hint && (
                      <div className="mt-3 rounded-lg border border-border/60 bg-background/28 px-3 py-2 text-[11px] text-muted-foreground">
                        {selectedSkill.ui_hint}
                      </div>
                    )}
                  </div>
